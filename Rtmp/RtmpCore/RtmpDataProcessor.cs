...
namespace RtmpCore
{
    ...
    {
        private readonly ILogger _logger = RtmpLogging.LoggerFactory.CreateLogger<RtmpDataProcessor>();
        private readonly RtmpSession _session;
        private readonly RtmpContext _context;

        public RtmpDataProcessor(RtmpContext context, RtmpSession session)
        {
